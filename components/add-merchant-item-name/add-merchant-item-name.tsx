...
function AddItemName(props: Props){

    const [name, getItemName] = React.useState('')
    ...
    const nextStep = () => {
      ...
      const  Item =  {
        ...
        props.navigation.navigate('Add-Price');
    }
    ...
    return (
      <View style={styles(props).body}>
        ...
        <View style={styles(props).container}>
          <Text style={styles(props).itemName}>
            {' '}
          ...
          <TouchableOpacity
            ...
            style={[
              name === ''
                ? styles(props).nextButtonDisabled
                : styles(props).nextButton,
            ]}
            onPress={() => nextStep()}>
